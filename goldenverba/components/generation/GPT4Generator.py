...
class GPT4Generator(Generator):
    ...
    async def generate_stream(
        ...
        try:
            ...
            print(f"\n###   base_url: {base_url}  openai.api_type : {openai.api_type}  model_name  {self.model_name}  openai.api_key : {openai.api_key}  openai.api_version : {openai.api_version}")
            ...
            print(f"\n###   chat_completion_arguments: {chat_completion_arguments}  ")
